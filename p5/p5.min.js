                    ...
                    function(M) {
                        ...
                        function Ne(e) {
                            ...
                            for (var i = 0, n = 0, o = 0; o < r.commands.length; o += 1) {
                                ...
                                else if ("L" === h.type) a = Math.round(h.x - i), s = Math.round(h.y - n), t.push({
                                    name: "dx",
                                    type: "NUMBER",
                                    value: a
                                }), t.push({
                        ...
                        function It(e, t) {
                            ...
                            for (var i = [], n = this.getLookupTables(t, r, e, 3), o = 0; o < n.length; o++)
                                for (var a = n[o].subtables, s = 0; s < a.length; s++)
                                    for (var h = a[s], l = this.expandCoverage(h.coverage), u = h.alternateSets, c = 0; c < l.length; c++) i.push({
                                        sub: l[c],
                                        by: u[c]
                                    });
                            return i
                        ...
                        function Gr(e) {
                            var t, r, i, n, o, a, s, h, l, u, c, p, d, f, m = new Mr({
                                    empty: !0
                                }),
                                v = new DataView(e, 0),
                                g = [],
